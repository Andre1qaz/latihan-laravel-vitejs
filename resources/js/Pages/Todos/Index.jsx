      ...
      header={
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="hidden items-center rounded-full bg-blue-600 px-4 py-2 text-xs font-medium text-white shadow-sm hover:bg-blue-500 sm:inline-flex"
          >
            + Tambah Todo
          </Link>
        </div>
    ...
    >
      ...
      <div className="py-6">
        <div className="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
          {/* FILTER TOOLBAR */}
          <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-blue-50">
            <form
              onSubmit={onSearch}
            ...
            >
              ...
              <div className="flex w-full items-end gap-2 md:w-auto md:justify-end">
                <button
                  type="submit"
                  className="inline-flex flex-1 items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-xs font-medium text-white shadow-sm hover:bg-blue-500 md:flex-none"
                >
                  Terapkan
                </button>
                ...
                <Link
                  href={route('todos.create')}
                  className="inline-flex flex-1 items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-xs font-medium text-white shadow-sm hover:bg-blue-500 md:hidden"
                >
                  + Todo
                </Link>
              </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-3 lg:col-span-2">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {todos.total} total todo, tampil {todos.data.length} pada halaman ini.
                  </p>
                </div>
              </div>
              ...
              {todos.data.map((todo, index) => (
                <div
                  key={todo.id}
                  className="flex flex-col gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-blue-50 sm:flex-row sm:items-stretch"
                >
                  {/* nomor + status + judul */}
                  <div className="flex flex-1 flex-col gap-2">
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-[11px] text-slate-400">
                      <span>Dibuat: {todo.created_at}</span>
                      <span>•</span>
                      <span>ID: {todo.id}</span>
                    </div>

                    {/* kalau mau, kamu bisa render snippet catatan (kalau note HTML panjang, ini bisa di-truncate) */}
                  </div>
                  ...
                  <div className="flex shrink-0 items-center justify-between gap-3 sm:flex-col sm:items-end sm:justify-between">
                    ...
                    <div className="flex gap-2 text-[11px]">
                      <Link
                        ...
                        className="rounded-full border border-blue-100 px-3 py-1 font-medium text-blue-600 hover:bg-blue-50"
                      >
                        Edit
                      </Link>
                      <button
                        ...
                        className="rounded-full border border-red-100 px-3 py-1 font-medium text-red-500 hover:bg-red-50"
                      >
                        Hapus
                      </button>
                    </div>
              ...
              {todos.data.length > 0 && (
                <div className="mt-3 flex items-center justify-between text-xs text-slate-500">
                  <p>
                    Halaman {todos.current_page} dari {todos.last_page}
                  </p>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl bg-blue-50 p-4 text-sm text-blue-900 ring-1 ring-blue-100">
                ...
                <p className="text-xs text-blue-900">Total Todos</p>
