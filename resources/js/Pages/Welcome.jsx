...
export default function Welcome() {
  const auth = { user: null } // Change to test authenticated state
  const laravelVersion = '11.x'
        ...
        <header className="w-full px-6 py-6 lg:py-10">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <nav className="flex items-center gap-2">
              {auth.user ? (
                <button className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-sm text-white font-medium hover:bg-white/20 transition-all border border-white/10">
                  Dashboard
                </button>
              ) : (
                <>
                  <button className="px-4 py-2 rounded-xl text-white font-medium hover:bg-white/10 transition-all">
                    Log in
                  </button>
                  <button className="px-4 py-2 rounded-xl bg-gradient-to-r from-red-600 to-orange-600 text-white font-medium hover:from-red-700 hover:to-orange-700 transition-all shadow-lg">
                    Register
                  </button>
                </>
              )}
          ...
          <div className="max-w-7xl w-full">
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-red-600 to-orange-600 text-white font-semibold hover:from-red-700 hover:to-orange-700 transition-all shadow-xl flex items-center gap-2">
                  Get Started
                  <ArrowRight className="w-5 h-5" />
                </button>
                <button className="px-6 py-3 rounded-xl bg-white/10 backdrop-blur-sm text-white font-semibold hover:bg-white/20 transition-all border border-white/10 flex items-center gap-2">
