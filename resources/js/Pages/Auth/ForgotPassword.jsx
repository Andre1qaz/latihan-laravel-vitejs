    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-8">
        ...
        <div className="w-full max-w-md relative">
          {/* Back Button */}
          <Link href={route('login')} className="mb-4 flex items-center gap-2 text-slate-300 hover:text-white transition group">
          ...
          <div className="bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl p-8 relative border border-slate-200/50">
            ...
            <div className="mt-6 pt-6 border-t border-slate-200 text-center space-y-3">
              <p className="text-sm text-slate-600">
                ...
                <Link href={route('login')} className="text-indigo-600 font-semibold hover:underline transition">
                  Login sekarang
                </Link>
              </p>
            </div>
