            ...
            {formData.password && (
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <p className="text-xs text-slate-500">
                  {formData.password.length < 5 && 'Password terlalu lemah'}
                  {formData.password.length >= 5 && formData.password.length < 8 && 'Password cukup kuat'}
                  {formData.password.length >= 8 && 'Password kuat'}
                </p>
              </div>
            )}
