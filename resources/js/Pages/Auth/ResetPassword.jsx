              ...
              {data.password && (
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <div className="flex gap-1 mb-2">
                    ...
                    <div className={`h-1.5 flex-1 rounded-full ${data.password.length >= 12 ? 'bg-violet-500' : 'bg-slate-200'}`}></div>
                  </div>
                  <div className="flex items-start gap-1.5 text-xs text-slate-600">
                    <CheckCircle2 className={`w-3.5 h-3.5 flex-shrink-0 mt-0.5 ${data.password.length >= 8 ? 'text-emerald-500' : 'text-slate-300'}`} />
